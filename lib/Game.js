...
var Game = window.GameOfLife.Game = function (options) {
  ...
  this._clearElement = options.clearElement     || document.createElement('div');
  ...
  this._board = new GameOfLife.Board({
    ...
    width: options.width,
    defaultPopulationDensity: options.defaultPopulationDensity,
    clickToToggle: options.clickToToggle
  });

  this._clearElement.addEventListener('click', this.handleClickClear.bind(this));
...
Game.prototype.getClearElement = function () {
...
Game.prototype.handleClickClear = function (event) {
